...
void UART3_Init()
{
		...
		UART3_IBRD_R = 130;  // 80,000,000/(16*115,200)) = 43.40278
		UART3_FBRD_R = 13;  //6-bbit fraction, round(0.40278 * 64) = 26
																					// 8 bit word length (no parity bits, one stop bit, FIFOs)
...
void UART4_Init()
{
		...
		UART4_IBRD_R = 130;  // 80,000,000/(16*115,200)) = 43.40278
		UART4_FBRD_R = 13;  //6-bbit fraction, round(0.40278 * 64) = 26
																					// 8 bit word length (no parity bits, one stop bit, FIFOs)
...
void UART5_Init()
{
		...
		UART5_IBRD_R = 130;  // 80,000,000/(16*115,200)) = 43.40278
		UART5_FBRD_R = 13;  //6-bbit fraction, round(0.40278 * 64) = 26
																					// 8 bit word length (no parity bits, one stop bit, FIFOs)
